...
COPY ./requirements-webui.txt /tmp/
...
# RUN pip uninstall -y torch torchvision torchaudio gsplat

# RUN pip install torch==2.4.0+cu121 torchvision==0.19.0+cu121 torchaudio==2.4.0+cu121 --index-url https://download.pytorch.org/whl/cu121

# RUN pip install gsplat --index-url https://docs.gsplat.studio/whl/pt24cu121

RUN pip install "numpy<2"

RUN apt-get update && apt-get install -y build-essential ninja-build git
